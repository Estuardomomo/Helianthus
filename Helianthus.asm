...
COUNTY 	EQU 0X21		;Lleva la cuenta de la cantidad de movientos en y
COUNTMINIX 	EQU 0X22	;Lleva la cuenta de cantidad de movimientos pequeños en X
LIMITY 	EQU 0X23		;Maxima cantidad de movimientos en y antes de regresar
LIMITMINIX	EQU 0X24	;Maxima cantidad de movimientos pequeños en X
P1	EQU 0X25		;Variable para el delay
COUNTX	EQU 0X26		;Cantidad de veces que me movere en miniX
LIMITX	EQU 0X27		;Cantidad de movimientos máximos en X
;Regresar a la posicion----
VARMAXX	EQU	0X28		;Rastrea movimientos en x para volver al punto maximo
VARMAXY	EQU	0X29		;Rastrea movimientos en y para volver al punto maximo
;Poder medir y guardar luz----
ADC	EQU	0X39
VALOR	EQU	0X30		;Obtiene el valor de luz actual
VALORMAX	EQU	0X31	;Valor máximo de luz
CounterA	EQU	0X32	;Contador Espera Jeff
CounterB	EQU	0X33	;Contador Espera Jeff
CounterC	EQU	0X34	;Contador Espera Jeff
;Comunicacion----
varB EQU 0x35	;Numero Máximo de otra maquina
varC EQU 0x36	;Numero mínimo de otra maquina
;Imprimir----
varE EQU 0x37	;Variable a Mostrar en el display
cont EQU 0x38 	;Contador para saber que resultado mostrar el Imprimir resultados.
...
CICLOXREVERSA
	...
	CALL	LIMIPIARX
	GOTO 	MENUIMPR	;TERMINAR EL PROGRAMA
CICLOMINIX
